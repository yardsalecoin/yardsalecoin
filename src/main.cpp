...
uint256 hashGenesisBlock("0xc0f9d0577508d029c42f6aa182f17eef5915a673fd014902eac948eb92714e80");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // YardSaleCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "YardSaleCoin Signed Message:\n";
...
{
    // YardSaleCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // YardSaleCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // YardSaleCoin: 3.5 days
static const int64 nTargetSpacing = 150; // YardSaleCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // YardSaleCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // YardSaleCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // YardSaleCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe2952a21c74340ebf01f9e15ef189662759fe80c94589b44309107a00a1c6657");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Yard Sale Coin for all your yard slae needs! aseriousgogetta";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("fec937b57b8e7965479ede596b08ab56cc61b6fda1e3fd8bd73e7eb75652d9d108d41f6f55651678c1fd70414ad44cf2728693a8052b6596ff951c8a135d3b67ce") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1412999877;
        block.nBits    = 504365644;
        block.nNonce   = 416480912;

        if (fTestNet)
        {
            block.nTime    = 1412999877;
            block.nNonce   = 1292406600;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x24041359f3a2a7c5b5787764b2355af6e18897b48a9a040fbfc78548977a4d34"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // YardSaleCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("YardSaleCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("YardSaleCoinMiner : ProcessBlock, block not accepted");
    }
